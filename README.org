...
| Phoenix Grove        | [[https://api.pgsgrove.com][API key]]                    |
#+html: </div>
...
#+begin_src emacs-lisp
;; Phoenix Grove offers an OpenAI compatible API
(gptel-make-openai "PhoenixGrove"       ;Any name you want
  :host "api.pgsgrove.com"
  :endpoint "/v1/chat/completions"
  :stream t
  :key "your-pgs-api-key"               ;can be a function that returns the key
  :models '(glm-5.3-flash deepseek-v4.1-flash kimi-k2.6 mimo-v2.6-pro))
#+end_src
